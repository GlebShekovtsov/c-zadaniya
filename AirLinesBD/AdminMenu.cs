...
namespace AirLinesBD
{
    public partial class AdminMenu : Form
    {
        ...
        private void списокПользователейToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            ViewUser(new UserView());
        }

        private void добавитьБилетToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            InsertTicket(new InsertTicket());
        }

        private void удалитьБилетToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            DeleteTicket(new DeleteTicket());
        }

        private void списокБилетовToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
